...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_document', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Course'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Document.course'
        raise RuntimeError("Cannot reverse this migration. 'Document.course' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.course'
        db.alter_column(u'main_document', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Course']))
