...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'History.date'
        db.alter_column(u'main_history', 'date', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'History.date'
        db.alter_column(u'main_history', 'date', self.gf('django.db.models.fields.DateTimeField')())
