...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.interactive'
        db.add_column(u'main_userprofile', 'interactive',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interactive.Interactive'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.budget'
        db.add_column(u'main_userprofile', 'budget',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=60000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.interactive'
        db.delete_column(u'main_userprofile', 'interactive_id')
    ...
    models = {
        ...
        u'main.document': {
            ...
            'document_type': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '3', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'main.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interactive': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['interactive.Interactive']", 'null': 'True', 'blank': 'True'}),
