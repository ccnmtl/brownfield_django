...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.user'
        db.alter_column(u'main_team', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, to=orm['auth.User'], unique=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Team.user'
        raise RuntimeError("Cannot reverse this migration. 'Team.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Team.user'
        db.alter_column(u'main_team', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
