...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.archive'
        db.add_column(u'main_course', 'archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.professor'
        db.add_column(u'main_course', 'professor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='taught_by', null=True, blank=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'main_course', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='created_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Course.archive'
        db.delete_column(u'main_course', 'archive')

        # Deleting field 'Course.professor'
        db.delete_column(u'main_course', 'professor_id')
