...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_information', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('history', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.History'], null=True, blank=True)),
            ('X', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('infoType', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('internalName', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
        ))
        db.send_create_signal(u'main', ['Information'])

        # Adding field 'PerformedTest.history'
        db.add_column(u'main_performedtest', 'history',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.History'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PerformedTest.testDetails'
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'main_information')

        # Deleting field 'PerformedTest.history'
        db.delete_column(u'main_performedtest', 'history_id')
    ...
    models = {
        ...
        u'main.information': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'infoType': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'internalName': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'})
        },
