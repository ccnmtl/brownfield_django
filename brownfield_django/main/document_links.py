...
LINK_1 = ("""<a href="javascript:openPopWin('{{STATIC_URL}}"""
          """flvplayer.html?flv=oryans_express.flv&amp;title="""
...
LINK_2 = ("""<a href="javascript:openPopWin('{{STATIC_URL}}"""
          ...
          """Press%20Conference%20Proceedings%20in%20Moraine%20"""
          """Township','500','500','no','no','bfaV2')">Video: """
...
LINK_4 = ("""<a href="javascript:openPopWin('{{STATIC_URL}}documents/"""
          ...
          """Water Testing Results Still Pending</a>""")
NAME_5 = """News: Water Testing Reveal Contamination"""
LINK_5 = ("""<a href="javascript:openPopWin('{{STATIC_URL}}documents/"""
          """news3.jpg','250','820','no','no','bfaN3')">News: """
          """Water Testing Reveal Contamination</a>""")
NAME_6 = """News: IRS Explores Terrain"""
LINK_6 = ("""<a href="javascript:openPopWin('{{STATIC_URL}}documents/"""
          """news4.jpg','260','900','no','no','bfaN4')">News: """
          """IRS Explores Terrain</a>""")
NAME_7 = """News: Doctor Still Haunted By Death of Patient"""
LINK_7 = ("""<a href="javascript:openPopWin('{{STATIC_URL}}documents/"""
          """news5.jpg','800','500','no','no','bfaN5')">News: """
          """Doctor Still Haunted By Death of Patient</a>""")
NAME_8 = """Link: Brownfield Action Reference Site"""
LINK_8 = ("""<a href="javascript:openPopWin('http://brownfieldref."""
          """ccnmtl.columbia.edu/','945','600','yes','yes','bfaref'"""
          """)">Link: Brownfield Action Reference Site</a>""")
