...
module('Collection and BaseCollection tests', {
    ...
    setup: function() {
        ...
        this.course_doc_collection =
            new DocumentCollection({'course': 5});
        this.student_collection = new StudentCollection();
        this.course_student_collection =
            new StudentCollection({'course': 5});
        this.instructor_collection = new InstructorCollection();
        this.course_instructor_collection =
            new InstructorCollection({'course':  5});
...
test('Test BaseCollection function/attribute and initalization', function() {
...
module('BaseItemView tests', {
    setup: function() {
        ...
        this.base_view = new BaseItemView({
            template: this.item_template, model: this.base_model});
    }
});
...
module('Document Visibility Test', {
    setup: function() {
        ...
        this.list.add(new AppDocument({
            ...
            visible: false}));
        this.listview = new DocumentListView({
